...
export default function Format() {
    ...
    const {
        ...
        kinkyu_kankei, kinkyu_num, kinkyu_name
            ...
            <center>
                <div className='signUp-container'>
                    ...
                    <div className='item dp'>
                        ...
                        {/* 部署 */}
                        <div className='dp-2'>
                            <SelectBox options={dplist} onChange={selectBusho}></SelectBox>
                        </div>
                        {/* ユニット */}
                        <div className='dp-3'>
                            <SelectBox options={unlist} TorF={TorF} toSentaku={toSentaku} onChange={selectUn}></SelectBox>
                        </div>
                    </div>
                ...
                <div className='buttons'>
                    <span className='buttons-1'>
                        <button type="button" class="btn btn-primary" onClick={send} >登録</button>
                    </span>
                    <span className='buttons-1'>
